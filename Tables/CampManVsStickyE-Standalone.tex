 \input{//Volumes/Data/Papers/cAndCwithStickyE/cAndCwithStickyE-AEJM/econtexPaths}\documentclass{\econtex}\usepackage{\econtexSetup}\usepackage{\econtexShortcuts}\provideboolean{StandAlone}\setboolean{StandAlone}{true}\input{//Volumes/Data/Papers/cAndCwithStickyE/cAndCwithStickyE-AEJM/Switches.tex}%\usepackage{endfloat}
\begin{document}
...
% \input{//Volumes/Data/Papers/cAndCwithStickyE/cAndCwithStickyE-AEJM/Tables/CampManVsStickyEinner.tex}\\
%   \end{tabular}
