 \input{"/$dstroot"/econtexPaths.tex} \documentclass{\econtex}\usepackage{\econtexSetup}\usepackage{\econtexShortcuts}\input{"/$dstroot"/Switches.tex}\provideboolean{StandAlone}\setboolean{StandAlone}{true}\setboolean{BigAndWide}{true}   \begin{document}\bibliographystyle{\econtexBibStyle} \setboolean{DocVersion}{false}  \newcommand{\texname}{Muth}\hfill{\tiny \today} \large
  \section{Formulae Derived from \cite{muthOptimal}}\label{appendix:Muth}

  \begin{verbatimwrite}{"/$dstroot"/LaTeX/appendices/MuthPre-muthOptimal.texinput}
...
\end{verbatimwrite}
\input{"/$dstroot"/LaTeX/appendices/MuthPre-muthOptimal.texinput}
  \begin{verbatimwrite}{/Volumes/Data/Papers/cAndCwithStickyE/cAndCwithStickyE-AEJM/Equations/muthOptimal.tex}
  \begin{eqnarray}
