...
In our calibration, the variance of the idiosyncratic permanent innovations at the quarterly frequency is about 100 times the variance of the aggregate permanent innovations ($4 \times $0.00004 divided by $% start input /Volumes/Data/Papers/cAndCwithStickyE/cAndCwithStickyE-AEJM/Calibration/PermShkVarAnn.tex
...
\\ \multicolumn{3}{c}{ $(\sigma_{\Psi}=\sigma_{\Theta}=\sigma_{\psi}=\sigma_{\theta}=\wp=\mathsf{D}=0$, $\Phi_t = 1)$} \  
...
\\ $\mathsf{D}$             & 0.005  & Probability of Mortality 
\\ \bottomrule 
